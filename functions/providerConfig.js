const inferCapabilities = (provider, modelId) => {
...
const buildAnthropicTools = (webSearchEnabled) => (
    webSearchEnabled
        ? [{
            type: 'web_search'
        }]
...
const buildGeminiTools = (webSearchEnabled) => (
    webSearchEnabled
        ? [{ googleSearch: {} }]
        : undefined
)

const buildMistralTools = (webSearchEnabled) => (
    webSearchEnabled
        ? [{ type: 'web_search' }]
        : undefined
)
